...
public class BCl_Gallery extends basicbcl {
    ...
    public void clickRandomNewsLink() throws InterruptedException {
    	...
    	// Create report        
        ExtentTest test = extent.createTest("Gallery", "Check the gallery shows");
      
        Thread.sleep(5000); 
        // Click on the News section
        driver.findElement(By.xpath("//androidx.appcompat.widget.LinearLayoutCompat[@resource-id=\"com.btracsolutions.bananiclub:id/llGallery\"]/android.widget.RelativeLayout/android.widget.ImageView"))
              .click();
        Thread.sleep(3000);
        test.log(Status.PASS, "This step shows by click on the Gallery");
        ...
        if (!newsLinks.isEmpty()) {
            ...
            Thread.sleep(3000);
            test.log(Status.PASS, "This step shows by clicking gallery it shows the details");
        } else {
            System.out.println("No news links found.");
            test.log(Status.FAIL, "No 'More' gallery pictures found. No gallery to display.");
        }
